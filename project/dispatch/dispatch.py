...
from project.task.mnist_dp_ada_classification.dispatch import (
    dispatch_config as dispatch_mnist_dp_ada_config,
)
from project.task.mnist_dp_ada_classification.dispatch import (
    dispatch_data as dispatch_mnist_dp_ada_data,
)
from project.task.mnist_dp_ada_classification.dispatch import (
    dispatch_train as dispatch_mnist_dp_ada_train,
)
